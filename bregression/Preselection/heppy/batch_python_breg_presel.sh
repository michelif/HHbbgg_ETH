...
xrdfs t3se01.psi.ch mkdir -p /store/user/nchernya/HHbbgg/b_regression/heppy/preselected_23_01_18/$2

xrdfs t3se01.psi.ch rm  /store/user/nchernya/HHbbgg/b_regression/heppy/preselected_23_01_18/$2/preselected_tree_$1.root 

xrdcp -f $TMPDIR/$2/preselected_tree_$1.root  root://t3dcachedb.psi.ch:1094//pnfs/psi.ch/cms/trivcat//store/user/nchernya/HHbbgg/b_regression/heppy/preselected_23_01_18/$2/
