...
#X_train_target = preprocessing.get_training_sample(pd.DataFrame(X_target),0.9)X_train_features = preprocessing.get_training_sample(pd.DataFrame(X_features),0.9)
...
clf = xgb.XGBRegressor(base_score=1.0, colsample_bylevel=1, colsample_bytree=1, gamma=0,
    ...
    #######   learning_rate=0.2, max_delta_step=0, max_depth=20,
     ...
     ######  min_child_weight=0.0002, missing=None, n_estimators=1000, nthread=2,
