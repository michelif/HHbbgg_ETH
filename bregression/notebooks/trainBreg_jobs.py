...
clf = optimization.optimize_parameters_randomizedCV_reg(xgb_model,X_train_features,X_train_target,X_test_features,X_test_target,param_grid,1,2,2)#nIter=20,cvOpt=5,nJobs=20
...
#end= 'full_energyring_fraction_jobs_fullparamestimation'
################
#end = 'test_jobs_tiny'
