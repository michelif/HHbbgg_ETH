...
labels=['Caterina','XGb w weights','XGb wo weights', 'only Cat variables']
...
for i_r,region in enumerate(pt_regions_names+eta_regions_names):
	file_name = path+'fitResultRegions_BukinComparisonThird'+region+'.txt'
