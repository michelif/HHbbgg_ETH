...
cuts='(Jet_pt > 20) & (Jet_eta<2.5 & Jet_eta>-2.5) & (Jet_mcFlavour==5 | Jet_mcFlavour==-5) & (Jet_mcPt>0) & (Jet_mcPt<6000) & (Jet_pt_reg>0)'
...
for num in range(len(outTags)):
    ...
    plotting.plot_feature_importance(loaded_model,features,outTags[num])
...
outTagComparison = 'firstComparison'
plotting.plot_regions(X_predictions_compare,comparison_tags,True,50,outTagComparison,False)
