...
name2="/mnt/t3nfs01/data01/shome/nchernya/HHbbgg_ETH_devel/root_files/heppy_05_10_2017/ttbar_unweighted_full80M.root"
f2 = TFile.Open(name2, "read")
...
#t2 = f2.Get("tree")
#hist2 = ROOT.TH1F("hist2","hist2",100,0,1500)
#t2.Draw("Jet_pt>>hist2",cuts)
...
for i in range(1,hist.GetNbinsX()+1):
	hist2.SetBinContent(i,hist.GetBinContent(i)*hist_ratio.GetBinContent(i))
...
leg.AddEntry(hist,"p_{T} spectrum" ,"L")
leg.AddEntry(hist2,"Unweighted p_{T}" ,"L")
leg.SetFillStyle(-1)
leg.SetBorderSize(0)
leg.SetTextFont(42)
...
frame2.GetYaxis().SetTitle("function")	
frame2.Draw()
...
c.SaveAs("../plots/unweighting_func_new.pdf")
