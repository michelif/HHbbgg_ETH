...
//	TString inputfilename ="/eos/cms/store/group/phys_higgs/vbfHbb/V25/GluGluToHHTo2B2G_node_SM_13TeV-madgraph/VHBB_HEPPY_V25_newReg_energyRing_upd_Efloat/171129_172205//0000/";
//	TString inputfilename ="/eos/cms/store/group/phys_higgs/vbfHbb/V25/GluGluToRadionToHHTo2B2G_M-500_narrow_13TeV-madgraph/VHBB_HEPPY_V25_newReg_energyRing_upd_Efloat/171129_172400/0000/";
//	TString inputfilename ="/eos/cms/store/group/phys_higgs/vbfHbb/V25/GluGluToRadionToHHTo2B2G_M-700_narrow_13TeV-madgraph/VHBB_HEPPY_V25_newReg_energyRing_upd_Efloat/171129_172705/0000/";
...
//	tree->SetBranchAddress("bTagWeight",&bTagWeight);
   ...
   float Jet_rawEnergy_;
	...
	float Jet_energyRing_dR0_neut_Jet_e_,Jet_energyRing_dR1_neut_Jet_e_,Jet_energyRing_dR2_neut_Jet_e_,Jet_energyRing_dR3_neut_Jet_e_,Jet_energyRing_dR4_neut_Jet_e_;
	float Jet_energyRing_dR0_ch_Jet_e_,Jet_energyRing_dR1_ch_Jet_e_,Jet_energyRing_dR2_ch_Jet_e_,Jet_energyRing_dR3_ch_Jet_e_,Jet_energyRing_dR4_ch_Jet_e_;
	float Jet_energyRing_dR0_em_Jet_e_,Jet_energyRing_dR1_em_Jet_e_,Jet_energyRing_dR2_em_Jet_e_,Jet_energyRing_dR3_em_Jet_e_,Jet_energyRing_dR4_em_Jet_e_;
	float Jet_energyRing_dR0_mu_Jet_e_,Jet_energyRing_dR1_mu_Jet_e_,Jet_energyRing_dR2_mu_Jet_e_,Jet_energyRing_dR3_mu_Jet_e_,Jet_energyRing_dR4_mu_Jet_e_;
...
//	outtree->Branch("bTagWeight",            &bTagWeight_ ,"bTagWeight_/F");
   ...
   outtree->Branch("Jet_energyRing_dR0_neut_Jet_e",&Jet_energyRing_dR0_neut_Jet_e_,"Jet_energyRing_dR0_neut_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR1_neut_Jet_e",&Jet_energyRing_dR1_neut_Jet_e_,"Jet_energyRing_dR1_neut_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR2_neut_Jet_e",&Jet_energyRing_dR2_neut_Jet_e_,"Jet_energyRing_dR2_neut_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR3_neut_Jet_e",&Jet_energyRing_dR3_neut_Jet_e_,"Jet_energyRing_dR3_neut_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR4_neut_Jet_e",&Jet_energyRing_dR4_neut_Jet_e_,"Jet_energyRing_dR4_neut_Jet_e_/F");

   outtree->Branch("Jet_energyRing_dR0_ch_Jet_e",&Jet_energyRing_dR0_ch_Jet_e_,"Jet_energyRing_dR0_ch_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR1_ch_Jet_e",&Jet_energyRing_dR1_ch_Jet_e_,"Jet_energyRing_dR1_ch_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR2_ch_Jet_e",&Jet_energyRing_dR2_ch_Jet_e_,"Jet_energyRing_dR2_ch_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR3_ch_Jet_e",&Jet_energyRing_dR3_ch_Jet_e_,"Jet_energyRing_dR3_ch_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR4_ch_Jet_e",&Jet_energyRing_dR4_ch_Jet_e_,"Jet_energyRing_dR4_ch_Jet_e_/F");
   
	outtree->Branch("Jet_energyRing_dR0_em_Jet_e",&Jet_energyRing_dR0_em_Jet_e_,"Jet_energyRing_dR0_em_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR1_em_Jet_e",&Jet_energyRing_dR1_em_Jet_e_,"Jet_energyRing_dR1_em_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR2_em_Jet_e",&Jet_energyRing_dR2_em_Jet_e_,"Jet_energyRing_dR2_em_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR3_em_Jet_e",&Jet_energyRing_dR3_em_Jet_e_,"Jet_energyRing_dR3_em_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR4_em_Jet_e",&Jet_energyRing_dR4_em_Jet_e_,"Jet_energyRing_dR4_em_Jet_e_/F");

   outtree->Branch("Jet_energyRing_dR0_mu_Jet_e",&Jet_energyRing_dR0_mu_Jet_e_,"Jet_energyRing_dR0_mu_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR1_mu_Jet_e",&Jet_energyRing_dR1_mu_Jet_e_,"Jet_energyRing_dR1_mu_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR2_mu_Jet_e",&Jet_energyRing_dR2_mu_Jet_e_,"Jet_energyRing_dR2_mu_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR3_mu_Jet_e",&Jet_energyRing_dR3_mu_Jet_e_,"Jet_energyRing_dR3_mu_Jet_e_/F");
   outtree->Branch("Jet_energyRing_dR4_mu_Jet_e",&Jet_energyRing_dR4_mu_Jet_e_,"Jet_energyRing_dR4_mu_Jet_e_/F");
...
//	for (Long64_t jentry=0; jentry<5;jentry++) {
		...
		if (!(rdn<current_pt_value)) continue;
			...
			Jet_energyRing_dR0_neut_Jet_e_ = Jet_energyRing_dR0_neut[i]/Jet_e_;
			Jet_energyRing_dR1_neut_Jet_e_ = Jet_energyRing_dR1_neut[i]/Jet_e_;
			Jet_energyRing_dR2_neut_Jet_e_ = Jet_energyRing_dR2_neut[i]/Jet_e_;
			Jet_energyRing_dR3_neut_Jet_e_ = Jet_energyRing_dR3_neut[i]/Jet_e_;
			Jet_energyRing_dR4_neut_Jet_e_ = Jet_energyRing_dR4_neut[i]/Jet_e_;

			Jet_energyRing_dR0_ch_Jet_e_ = Jet_energyRing_dR0_ch[i]/Jet_e_;
			Jet_energyRing_dR1_ch_Jet_e_ = Jet_energyRing_dR1_ch[i]/Jet_e_;
			Jet_energyRing_dR2_ch_Jet_e_ = Jet_energyRing_dR2_ch[i]/Jet_e_;
			Jet_energyRing_dR3_ch_Jet_e_ = Jet_energyRing_dR3_ch[i]/Jet_e_;
			Jet_energyRing_dR4_ch_Jet_e_ = Jet_energyRing_dR4_ch[i]/Jet_e_;
			
			Jet_energyRing_dR0_em_Jet_e_ = Jet_energyRing_dR0_em[i]/Jet_e_;
			Jet_energyRing_dR1_em_Jet_e_ = Jet_energyRing_dR1_em[i]/Jet_e_;
			Jet_energyRing_dR2_em_Jet_e_ = Jet_energyRing_dR2_em[i]/Jet_e_;
			Jet_energyRing_dR3_em_Jet_e_ = Jet_energyRing_dR3_em[i]/Jet_e_;
			Jet_energyRing_dR4_em_Jet_e_ = Jet_energyRing_dR4_em[i]/Jet_e_;
	
			Jet_energyRing_dR0_mu_Jet_e_ = Jet_energyRing_dR0_mu[i]/Jet_e_;
			Jet_energyRing_dR1_mu_Jet_e_ = Jet_energyRing_dR1_mu[i]/Jet_e_;
			Jet_energyRing_dR2_mu_Jet_e_ = Jet_energyRing_dR2_mu[i]/Jet_e_;
			Jet_energyRing_dR3_mu_Jet_e_ = Jet_energyRing_dR3_mu[i]/Jet_e_;
			Jet_energyRing_dR4_mu_Jet_e_ = Jet_energyRing_dR4_mu[i]/Jet_e_;
