...
fileDir= ROOT.TString("/mnt/t3nfs01/data01/shome/micheli/HHbbgg_ETH_devel/outfiles/20171012_ggH_ttH/Total_preselection_diffNaming.root")
...
for tree in trees:
    ...
    tree.Project("h_highMass","Mgg","weight*(MVAOutput>0.58 && Mgg>123.5 && Mgg<126.5 && Mjj>90 && Mjj<155 && MX>340)")
