...
#fileDir= ROOT.TString("/mnt/t3nfs01/data01/shome/micheli/HHbbgg_ETH_devel/outfiles/20170828_optimizedCuts_ggH_reweight/Total_preselection_diffNaming.root")
fileDir= ROOT.TString("/mnt/t3nfs01/data01/shome/micheli/HHbbgg_ETH_devel/outfiles/20170828_optimizedCuts_ggH_reweight_scale10/Total_preselection_diffNaming.root")
...
for tree in trees:
    ...
    tree.Project("h_highMass","Mgg","weight*(MVAOutput>0.967 && Mgg>123.5 && Mgg<126.5 && Mjj>90 && Mjj<155&& MX>340)")
